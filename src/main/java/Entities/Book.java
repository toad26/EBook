...
public class Book {
    ...
    public boolean equals(Object o) {
        ...
        return id == book.id &&
                ...
                isbn == book.isbn &&
                Double.compare(book.listPrice, listPrice) == 0 &&
                numberOfPages == book.numberOfPages &&
                Double.compare(book.ourPrice, ourPrice) == 0 &&
                Double.compare(book.shippingWeight, shippingWeight) == 0 &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, active, author, category, description, format, inStockNumber, isbn, language, listPrice, numberOfPages, ourPrice, publicationDate, publisher, shippingWeight, title);
    }
