...
public class UserShipping {
    ...
    public boolean equals(Object o) {
        ...
        return id == that.id &&
                userShippingDefault == that.userShippingDefault &&
                Objects.equals(userShippingCity, that.userShippingCity) &&
                Objects.equals(userShippingCountry, that.userShippingCountry) &&
                Objects.equals(userShippingName, that.userShippingName) &&
                Objects.equals(userShippingState, that.userShippingState) &&
                Objects.equals(userShippingStreet1, that.userShippingStreet1) &&
                Objects.equals(userShippingStreet2, that.userShippingStreet2) &&
                Objects.equals(userShippingZipcode, that.userShippingZipcode) &&
                Objects.equals(userId, that.userId);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, userShippingCity, userShippingCountry, userShippingDefault, userShippingName, userShippingState, userShippingStreet1, userShippingStreet2, userShippingZipcode, userId);
    }
